  ...
  <aside class="w-full shrink-0 lg:w-80">
    <div class="flex flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-600 dark:bg-gray-800">
      <header class="border-b border-gray-100 px-4 py-3 dark:border-gray-700">
        <h3 class="text-base font-semibold">Filtres</h3>
        <p class="text-xs text-gray-400">Affinez votre recherche</p>
      </header>

      <div class="flex flex-col gap-5 overflow-y-auto p-4">
        <!-- Canton -->
        <div class="flex flex-col gap-1.5">
          <label for="filter-canton" class="text-xs font-semibold uppercase tracking-wide text-gray-500">
            Canton
          </label>
          <select
            id="filter-canton"
        ...
        <!-- Commune -->
        <div class="flex flex-col gap-1.5">
          <label for="filter-commune" class="text-xs font-semibold uppercase tracking-wide text-gray-500">
            Commune
          </label>
          <select
            id="filter-commune"
        ...
        <!-- Préfecture -->
        <div class="flex flex-col gap-1.5">
          <label for="filter-prefecture" class="text-xs font-semibold uppercase tracking-wide text-gray-500">
            Préfecture
          </label>
          <select
